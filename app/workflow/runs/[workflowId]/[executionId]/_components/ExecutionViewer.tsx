...
export default function ExecutionViewer({
  ...
  const [selectedPhase, setsSelectedPhase] = useState<string | null>(null);
  ...
  useEffect(() => {
    ...
    if (isRunning) {
      ...
      setsSelectedPhase(phaseToSelect.id);
      return;
    }
    ...
    setsSelectedPhase(phaseToSelect.id);
  }, [query.data?.phases, isRunning, setsSelectedPhase]);
      ...
      <aside className="w-[440px] min-w-[440px] max-w-[440px] border-r-2 border-separate flex flex-grow flex-col overflow-hidden">
        <div className="py-4 px-2">
          ...
          <ExecutionLabel
            ...
            label="Status"
            value={
              <div className="flex items-center font-semibold capitalize gap-2">
                <PhaseStatusBadge
